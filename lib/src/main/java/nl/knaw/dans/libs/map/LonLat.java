...
/**
 * Geographical coordinate pair; Longitude, Latitude Coordinate system WGS84 assumed: Coordinates are Latitude and Longitude as signed decimal degrees with
 * negative longitude in the western hemisphere and negative latitude in the southern hemisphere. The normal range for longitude is -180 West to 0 (greenwich)
 * to 180 East and the normal range of latitude is -90 Southpole to 0 equator to 90 Northpole WGS84 is EPSG:4326 or in GML: Point
 * srsName="urn:ogc:def:crs:EPSG:6.6:4326" Note: there is no check for these ranges! Out of the bounds could be the result of erratic swapping Lon and Lat or
 * forgetting to do a cyclic reduction after calculations.
 */
