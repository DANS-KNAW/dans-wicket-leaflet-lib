...
public class HomePage extends WebPage {
    ...
    public HomePage(final PageParameters parameters) {
        ...
        // Map example pages
        add(new BookmarkablePageLink<BasicMapViewerPage>("basicgeoviewpagelink", BasicMapViewerPage.class));
        add(new BookmarkablePageLink<LazyLoadingMapViewerPage>("lazyloadinggeoviewtestpagelink", LazyLoadingMapViewerPage.class));
        add(new BookmarkablePageLink<AjaxMapViewerPage>("geoviewajaxtestpagelink", AjaxMapViewerPage.class));
        add(new BookmarkablePageLink<JsonFileLoadGeoViewerExamplePage>("jsonfileloadinggeoviewtestpagelink", JsonFileLoadGeoViewerExamplePage.class));
    }
}
